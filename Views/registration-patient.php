            ...
            <div class="login__forms">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="login__register" id="login-in">
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="password" name="password" id="password" class="form__input" value="<?php $Password; ?>">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="login__create none" id="login-up">
                    ...
                    <div class="form__div form__div-one">
                        ...
                        <div class="form__div-input">
                            <label for="" class="form__label">Username</label>
                            <input type="text" name="username" id="username-register" class="form__input">
                            <i class='bx bxs-user-check'></i>
                            <i class='bx bxs-error-circle' id="user-check"></i>
                        </div>
                    </div>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" name="email" id="email-register" class="form__input">
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            <label for="" class="form__label">Password</label>
                            <input type="password" name="password" id="password-register" class="form__input">
                            <i class='bx bxs-check-shield'></i>
                            <i class='bx bxs-error-circle'></i>
                        </div>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="password" name="password" id="cpassword-register" class="form__input">
                            <i class='bx bxs-check-shield'></i>
                            <i class='bx bxs-error-circle'></i>
                        </div>
                    ...
                    <!-- <a href="#" class="login__forgot">Forgot Password?</a> -->
                    <input type="submit" class="login__button" name="submit" value="Sign Up">
