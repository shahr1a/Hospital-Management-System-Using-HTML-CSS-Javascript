...
<body>
    <div class="main__container">
        ...
        <div class="main">
            ...
            <div class="link top__nav selected">
            ...
            <section class="s home show" id="home">
                <div class="content">
            ...
            <!-- Appointment -->
            <div class="link top__nav">
                <a href="#" class="logo">Appointment</a>
                <nav class="navbar">
                    <a href="#home">Schedule Appointment</a>
                    <a href="#prevent">View All</a>
                </nav>
            </div>
            <!-- Medicine -->
            <div class="link top__nav">
    ...
    <script src="./../assets/js/app_home.js"></script>
    <script>
